# Generated by Django 4.1.9 on 2023-06-28 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('talla', models.CharField(choices=[('S', 'S'), ('M', 'M'), ('L', 'L')], max_length=2)),
                ('color', models.CharField(choices=[('negro', 'negro'), ('blanco', 'blanco'), ('gris', 'gris')], max_length=20)),
